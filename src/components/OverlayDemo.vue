				...
				<div class="p-grid p-formgrid">
					...
					<div class="p-col-6">
						...
						<OverlayPanel ref="op2" appendTo="body" :showCloseIcon="true" id="overlay_panel" style="width: 450px" :breakpoints="{'960px': '75vw', '640px': '100vw'}">
							<DataTable :value="products" v-model:selection="selectedProduct" selectionMode="single" :paginator="true" :rows="10" responsiveLayout="scroll" @row-select="onProductSelect">
