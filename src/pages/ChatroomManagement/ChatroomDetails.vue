    ...
    <div class="p-grid">
        <div class="p-col-12">
            <div class="card p-fluid">
                ...
                <div class="p-field p-grid">
                    <label for="category_name_ko" class="p-col-12 p-mb-2 p-md-2 p-mb-md-0">채팅방 이미지:</label>
                    <div class="p-col-12 p-md-10">
                        <span v-if="group_image == ''">
                            <p>이미지 없음</p>
                            
                        </span>
                        <span v-else>
                            <img :src="group_image"  class="product-image" />
                        </span>
                ...
                <div class="p-field p-grid">
                    ...
                    <div class="p-col-12 p-md-10">
                        <span v-if="group_type == 'location'">
                        {{ address }} ({{ $t(group_type) }})
                        </span>
                        <span v-else>
                            {{city}}, {{country}}
                        </span>
                ...
                <div class="p-field p-grid">
                    ...
                    <div class="p-col-12 p-md-10">
                        <p>{{ formatDate(latest_message_time) == null ? '-': formatDate(latest_message_time) }}
                           </p>
                    </div>
                </div>
    ...
    <div class="p-col-12">
        <div class="card">
            ...
            <DataTable :value="customer1" :paginator="true" class="p-datatable-gridlines" :rows="10" dataKey="id" :rowHover="true" :loading="loading1" :filters="filters1" responsiveLayout="scroll">
                ...
                <Column header="참가 일시" style="min-width: 12rem" field="participated_date" :sortable="true">
                    <template #body="{ data }">
                        <span class="p-column-title">Participated date & time</span>
                        {{ formatDate(data.participated_date) }}
                    </template>
                </Column>
...
export default {
    ...
    mounted() {
        ...
        this.chatroomService.viewchatroomdetail(this.$route.params.id).then((res) => {
            // console.log(res);
            ...
            this.group_image = res.data.room_details.group_image;
